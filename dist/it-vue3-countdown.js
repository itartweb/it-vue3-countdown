(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["it-vue3-countdown"] = {}, global.Vue, global.crypto));
	...
	const __default__ = {
	  ...
	  setup(props, {emit}) {
	    ...
	    let now = vue.ref(Math.trunc(new Date().getTime() / 1000));
	    let date = vue.ref(null);
	    let interval = vue.ref(null);
	    let diff = vue.ref(0);
	    let show = vue.ref(false);
	    let timeData = vue.ref([
	      {
	        current: 0,
	        previous: 0,
	    ...
	    let seconds = vue.computed(() => {
	      return Math.trunc(diff.value) % 60;
	    });

	    let minutes = vue.computed(() => {
	      return Math.trunc(diff.value / 60) % 60;
	    });
	    let hours = vue.computed(() => {
	        ...
	        ($props.flipAnimation)
	          ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
	              vue.createElementVNode("span", {
	                ...
	                style: vue.normalizeStyle($props.countdownSize ? `font-size:${$props.countdownSize}` : '')
	              }, [
	                vue.createElementVNode("b", _hoisted_4, vue.toDisplayString($setup.twoDigits(data.current)), 1 /* TEXT */),
	          ...
	          : (vue.openBlock(), vue.createElementBlock("div", _hoisted_8, [
	              vue.createElementVNode("span", _hoisted_9, vue.toDisplayString($setup.twoDigits(data.current)), 1 /* TEXT */)
	            ])),
	        ($props.showLabels)
	          ? (vue.openBlock(), vue.createElementBlock("span", {
	              key: 2,
	              class: "flip-clock__slot",
	              style: vue.normalizeStyle($props.labelSize ? `font-size:${$props.labelSize}` : '')
...
//# sourceMappingURL=it-vue3-countdown.js.map
